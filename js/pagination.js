...
var Pagination = {
    ...
    Last: function () {
        Pagination.code += '<i role="presentation"></i><button role="link" data-text="' + Pagination.size + '"  class="by-keyboard"><span class="show-for-sr">page </span>' + Pagination.size + '</button>';
    },

    // add first page with separator
    First: function () {
        Pagination.code += '<button role="link" data-text="1" class="by-keyboard"><span class="show-for-sr">page </span>1</button><i role="presentation"></i>';
    },
